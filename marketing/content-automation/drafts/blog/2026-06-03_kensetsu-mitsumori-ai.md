...
ボイス見積のデモでは、音声入力から明細候補を作り、単価マスター、社内情報分離、Excel/PDF出力までの流れを確認できます。まずは[デモページ](https://web-beryl-one-79.vercel.app/lp)で流れだけ見てください。
...
ボイス見積はまだプロトタイプですが、音声入力、単価マスター、情報分離、Excel/PDF出力の流れを試せます。興味があれば、[デモページ](https://web-beryl-one-79.vercel.app/lp)から確認してください。
